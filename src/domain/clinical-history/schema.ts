...
export const ClinicalHistorySchema = z.object({
  ...
  previous_abnormal_results: slotSchema,
  ...
  physical_exam_general: slotSchema,
  physical_exam_head_neck: slotSchema,
  physical_exam_chest: slotSchema,
  physical_exam_abdomen: slotSchema,
  physical_exam_extremities: slotSchema,
  physical_exam_genitourinary: slotSchema,
  physical_exam_neurological: slotSchema,
  physical_exam_skin_soft_tissues: slotSchema,
...
export const emptyClinicalHistory: ClinicalHistory = {
  ...
  previous_abnormal_results: null,
  ...
  physical_exam_general: null,
  physical_exam_head_neck: null,
  physical_exam_chest: null,
  physical_exam_abdomen: null,
  physical_exam_extremities: null,
  physical_exam_genitourinary: null,
  physical_exam_neurological: null,
  physical_exam_skin_soft_tissues: null,
